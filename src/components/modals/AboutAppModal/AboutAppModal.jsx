      ...
      <>
        ...
        <div className="modal-body">
          ...
          <section>
            <h3>Gallery</h3>
            <p>
              The Gallery allows users to browse images and open them in a
              preview modal. Each image can be viewed in a larger format with
              additional details. This demonstrates working with image data,
              modal windows, and component interaction.
            </p>
          </section>
          ...
          <p>
            <em>
              ...
              conditional rendering, reusable components, and working with
              modals.
            </em>
          </p>
        </div>
